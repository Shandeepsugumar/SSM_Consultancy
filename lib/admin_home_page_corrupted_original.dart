...
class _EmployeeAttendancePageState extends State<EmployeeAttendancePage> {
  ...
  Future<void> _loadEmployeesWithAttendance() async {
    ...
    try {
      print('🚀 FIXED: Loading employees with working attendance data...');
  ...
  Widget build(BuildContext context) {
    ...
    int totalPresent = _employees.fold(0, (sum, emp) => sum + (emp['presentDays'] as int));
    int totalHalfDay = _employees.fold(0, (sum, emp) => sum + (emp['halfDaysPresentCount'] as int));
    int totalAbsent = _employees.fold(0, (sum, emp) => sum + (emp['absentDays'] as int));
            ...
            child: Column(
              children: [
                ...
                Row(
                  ...
                  children: [
                    _buildStatCard('Employees', '${_employees.length}', Icons.people, Colors.blue),
                    _buildStatCard('Present', '$totalPresent', Icons.check_circle, Colors.green),
                    _buildStatCard('Half Day', '$totalHalfDay', Icons.schedule, Colors.orange),
                    _buildStatCard('Absent', '$totalAbsent', Icons.cancel, Colors.red),
                  ],
                ),
              ],
            ),
            ...
            child: _isLoading
                ...
                : _filteredEmployees.isEmpty
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          var emp = _filteredEmployees[index];
                          return Card(
                            ...
                            child: ListTile(
                              ...
                              subtitle: Column(
                                ...
                                children: [
                                  ...
                                  Text('EID: ${emp['eid']}'),
                                  Text('Records: ${emp['attendanceCount']}'),
                                  if (emp['recentDates'].isNotEmpty)
                                    Text('Recent: ${emp['recentDates'].take(3).join(', ')}'),
                                ],
                              ),
                              trailing: Column(
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: [
                                  Text('P: ${emp['presentDays']}', style: TextStyle(color: Colors.green)),
                                  Text('H: ${emp['halfDaysPresentCount']}', style: TextStyle(color: Colors.orange)),
                                  Text('A: ${emp['absentDays']}', style: TextStyle(color: Colors.red)),
                                ],
                              ),
                            ),
                          );
